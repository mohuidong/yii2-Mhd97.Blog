                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <!--<div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php /*echo $form->field($model, 'class')->textInput(["class" => "form-control", "placeholder" => $modelLabel->getAttributeLabel("class"), "id" => 'class']) */?>
                            </div>
                        </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <img src="<?=$model->img?:'/backend/web/images/default.jpg'?>" class="change_img img" type="img" style="width: 90px;height: 80px">
                                <input type="hidden" name="AdminPost[img]" id="img" value="<?=$model->img?>">
                                <input type="file" name="file" id="hiddenFile" onChange="ajaxFileUpload()" style="display: none">
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
