                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            <label for="title"
                                   class="col-sm-2 control-label">问题</label>
                            <div class="col-sm-8">
                                <div class="form-control"
                                     style="height: auto;min-height: 34px;"><?= \common\models\Question::getQuestionName($model->question_id)?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="form-group">
                            <label for="title"
                                   class="col-sm-2 control-label">回复</label>
                            <div class="col-sm-8">
                                <div class="form-control"
                                     style="height: auto;min-height: 34px;"><?= $model->answer ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
